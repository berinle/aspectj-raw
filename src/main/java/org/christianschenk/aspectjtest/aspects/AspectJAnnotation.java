...
public class AspectJAnnotation {
	...
	public void beforeHelloWorld(final JoinPoint thisJoinPoint) {
		...
		System.out.println("Before: " + thisJoinPoint.getStaticPart().getSignature().getName());
	}
	...
	public void afterHelloWorld(final JoinPoint thisJoinPoint) {
		...
		System.out.println("After: " + thisJoinPoint.getStaticPart().getSignature().getName());
	}
	...
	public void aroundMainConstructor(final JoinPoint thisJoinPoint) {
		...
		System.out.println("Around : " + thisJoinPoint.getStaticPart().getSignature().getName());
	}
}